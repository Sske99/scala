...
object Classes {
  ...
  def main(args: Array[String]): Unit ={
    val cat: Animals = new Animals("cat","mammal","meat")
    println("Wolf eat meat: " + cat.eats("meat"))
    println("Animal is known: " + Animal.KnownAnimal("goldfish"))
    println("Animal.apply: " + Animal.apply("parrot").isEmpty)
    println("Food.apply: " + Food.apply("apple").isEmpty)
